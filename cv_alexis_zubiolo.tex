...
\cventry{June 2017 -- present}{Machine Learning Engineer}{\href{https://www.hyperscience.com/}{HyperScience}}{Sofia, Bulgaria}{}
{
\begin{itemize}
...
\cvitem{Programming}{Python (sk-learn, NumPy, TensorFlow), Scala (Spark, Breeze), Java, Matlab, SQL, bash}
\cvitem{Multidisciplinary}{Extended experience interacting with professionals from a variety of fields (Biologists, Medical Doctors, Sales and Marketing managers)}
